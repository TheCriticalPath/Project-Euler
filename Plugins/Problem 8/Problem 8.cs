...
namespace Problem_8
{
    ...
    public class Problem_8 : IEulerPlugin
    {
        ...
        private long GetLimit()
        {
            ...
            while (lngLimit < 1)
            {
                Helpers.InputHelper.Show(Name, "Enter number of consecutive digits.", ref strLimit);
        ...
        public string GetSeries()
        {
            ...
            while (strSeries.Length <= _limit)
            {
                ...
                Helpers.InputHelper.Show(Name, string.Format("Enter numeric series longer than {0}", _limit), ref strSeries);
